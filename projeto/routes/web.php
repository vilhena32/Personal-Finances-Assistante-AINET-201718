...
Route::get('/me/password','HomeController@showChangePasswordForm')->middleware('auth');
Route::post('/me/password','HomeController@changePassword')->name('changePassword')->middleware('auth');
